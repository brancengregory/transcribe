...
The **transcribe** package provides an R interface to audio transcription using Whisper, with optional post‐processing via Ollama. It also includes a sample plumber API for a web interface and a command-line interface (CLI).
...
This command will transcribe the audio file and save the output to `transcribe.txt`.
